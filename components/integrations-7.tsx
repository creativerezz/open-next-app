                    ...
                    <div className="bg-muted/25 group relative mx-auto max-w-[22rem] items-center justify-between space-y-6 [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] sm:max-w-md">
                        ...
                        <div>
                            <InfiniteSlider
                                ...
                                speedOnHover={10}>
                                <IntegrationCard>
                                    <Image src="/automations-light.png" alt="Automations" width={20} height={20} className="dark:hidden" />
                                    <Image src="/automations-dark.png" alt="Automations" width={20} height={20} className="hidden dark:block" />
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/payments.png" alt="Payments" width={20} height={20} />
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/calendar.png" alt="Calendar" width={20} height={20} />
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/light.png" alt="Light Mode" width={20} height={20} className="dark:hidden" />
                                    <Image src="/dark.png" alt="Dark Mode" width={20} height={20} className="hidden dark:block" />
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/image.png" alt="Images" width={20} height={20} />
                                </IntegrationCard>
                                <IntegrationCard>
                                    <Image src="/automations-light.png" alt="Automations" width={20} height={20} className="dark:hidden" />
                                    <Image src="/automations-dark.png" alt="Automations" width={20} height={20} className="hidden dark:block" />
