                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-3xl text-center">
                            <h1 className="text-balance text-4xl font-geist-sans md:text-5xl lg:text-6xl text-foreground tracking-tight">Transform Your Business with AI Automation</h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl">From custom chatbots to workflow automation, we help businesses leverage AI to increase efficiency, reduce costs, and accelerate growth.</p>
